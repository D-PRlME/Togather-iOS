...
extension Font {
    ...
    static let title1m = custom("Pretendard-Medium", size: 28)
    static let title1b = custom("Pretendard-Bold", size: 28)
    static let title2m = custom("Pretendard-Medium", size: 24)
    static let title2b = custom("Pretendard-Bold", size: 24)
